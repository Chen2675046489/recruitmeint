    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('born_address', models.CharField(blank=True, max_length=135, verbose_name='户籍')),
                ('gender', models.CharField(blank=True, max_length=135, verbose_name='性别')),
                ('candidate_remark', models.CharField(blank=True, max_length=255, verbose_name='备注')),
                ...
                ('first_score', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='初始分数')),
                ('first_learning_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='学习能力得分')),
                ('first_professional_competency', models.DecimalField(blank=2, decimal_places=1, max_digits=2, null=True, verbose_name='专业能力得分')),
                ...
                ('first_result', models.CharField(blank=True, choices=[('建议录用', '建议录用'), ('待定', '待定'), ('放弃', '放弃')], max_length=256, verbose_name='初试结果')),
                ('first_recommend_position', models.CharField(blank=True, max_length=256, verbose_name='推荐部分')),
                ('first_interviewer', models.CharField(blank=True, max_length=1024, verbose_name='面试官')),
                ...
                ('second_professional_competency', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='追求卓越得分')),
                ('second_pursue_of_excellence', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='沟通能力得分')),
                ...
                ('second_result', models.CharField(blank=True, choices=[('建议复试', '建议复试'), ('待定', '待定'), ('放弃', '放弃')], max_length=256, verbose_name='专业f复试结果')),
                ...
                ('hr_communication_ability', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='坦诚沟通')),
                ('hr_logic_ability', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR逻辑思维')),
                ('hr_potential', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR发展能力')),
                ...
                ('hr_interviewer', models.CharField(blank=True, max_length=1024, verbose_name='HR面试官')),
                ...
                ('last_editor', models.CharField(blank=True, max_length=256, verbose_name='最后编辑人')),
            ],
            options={
                'verbose_name': '应聘者',
